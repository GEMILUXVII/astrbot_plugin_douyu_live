...
<div align="center">
  <a href="CHANGELOG.md"><img src="https://img.shields.io/badge/version-v2.2.12-9644F4?style=for-the-badge" alt="Version"></a>
...
2. **重启/重载 AstrBot**
   ...
   `requirements.txt` 从 PyPI 安装 `aiodouyu>=0.4.9,<0.5`，不会从相邻
   源码目录导入。
